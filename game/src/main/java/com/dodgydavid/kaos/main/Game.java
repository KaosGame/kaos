package com.dodgydavid.kaos.main;
...
import com.dodgydavid.kaos.collision.objects.Bank1CollidableObjest;
...
import com.dodgydavid.kaos.collision.objects.LastMapCollidableObject;
import com.dodgydavid.kaos.collision.objects.LavaTransparentCollisionObject;
import com.dodgydavid.kaos.collision.objects.NextRandomMapCollisionObject;
import com.dodgydavid.kaos.collision.objects.Pot7Or2CollidableObject;
import com.dodgydavid.kaos.collision.objects.StartMonsterLeathFightCollidableObject;
...
import com.dodgydavid.kaos.display.HUD;
import com.dodgydavid.kaos.display.components.GamePanel;
...
import com.dodgydavid.kaos.entities.ItemEntity;
import com.dodgydavid.kaos.entities.bad.zombie.WarZombie;
...
import com.dodgydavid.kaos.entities.cats.Kittnasours;
...
import com.dodgydavid.kaos.entities.vilagers.VillagerTrades;
import com.dodgydavid.kaos.exceptions.image.restoring.NotEnoughInformationToRestoreImageException;
import com.dodgydavid.kaos.gui.base.GUI;
import com.dodgydavid.kaos.logging.LogType;
import com.dodgydavid.kaos.logging.Logger;
...
import com.dodgydavid.kaos.maps.MapHandler;
import com.dodgydavid.kaos.random.RandomGen;
import com.dodgydavid.kaos.saving.GameVersion;
import com.dodgydavid.kaos.saving.SaveableObject;
import com.dodgydavid.kaos.saving.SavingGame;
import com.dodgydavid.kaos.sound.Sound;
import com.dodgydavid.kaos.sound.Sounds;
import com.dodgydavid.kaos.textures.BufferedImageLoader;
import com.dodgydavid.kaos.textures.TextraAlice;
...
public class Game {
	...
	public static void fixImagesForCurrentMap(Map map) throws NotEnoughInformationToRestoreImageException {
		...
		Iterator<com.dodgydavid.kaos.maps.Dimension> dimsListIt = Game.DIMENSION_HANDLER.getDimensionHashMap().values().iterator();
		
		while (dimsListIt.hasNext()) {
			
			com.dodgydavid.kaos.maps.Dimension dim = dimsListIt.next();
