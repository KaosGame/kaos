...
import com.github.kaosgame.kaos.entities.player.items.BowlItem;
...
import com.github.kaosgame.kaos.entities.player.items.dimension.teleporters.FishLandDimensionTeleporterItem;
...
import com.github.kaosgame.kaos.entities.player.items.food.BurgerFoodItem;
...
import com.github.kaosgame.kaos.entities.player.items.food.PizzaFoodItem;
...
import com.github.kaosgame.kaos.entities.player.items.objects.BombItem;
...
import com.github.kaosgame.kaos.entities.player.items.objects.Sign1Item;
...
import com.github.kaosgame.kaos.entities.player.items.tools.weapon.SwordItem;
...
public class VillagerEntity extends Entity implements Trading {
	...
	public void tradeAll() {
		...
		if (this.tradeItem == VillagerTrades.WOOD_TO_COIN) {
			...
			while (Game.PLAYER.getHotbar().hasItemValue(tempItem) >= 5 && count < Item.MAX_COUNT) {
			...
			while (Game.PLAYER.getCoins() >= 2 && count < Item.MAX_COUNT) {
			...
			while (Game.PLAYER.getHotbar().hasItemValue(tempItem) >= 2 && count < Item.MAX_COUNT) {
			...
			while (Game.PLAYER.getCoins() >= 4 && count < Item.MAX_COUNT) {
			...
			while (Game.PLAYER.getCoins() >= 8 && count < Item.MAX_COUNT) {
			...
			while (Game.PLAYER.getHotbar().hasItemValue(tempItem) >= 7 && count < Item.MAX_COUNT) {
			...
			while (Game.PLAYER.getHotbar().hasItemValue(tempItem) >= 1 && count < Item.MAX_COUNT) {
			...
			while (Game.PLAYER.getCoins() >= 1 && count < Item.MAX_COUNT) {
			...
			while (Game.PLAYER.getHotbar().hasItemValue(tempItem) >= 3 && count < Item.MAX_COUNT) {
			...
			while (Game.PLAYER.getHotbar().hasItemValue(tempItem1) >= 1 && Game.PLAYER.getHotbar().hasItemValue(tempItem2) >= 3 && count < Item.MAX_COUNT) {
			...
			while (Game.PLAYER.getCoins() >= 3 && count < Item.MAX_COUNT) {
			...
			while (Game.PLAYER.getCoins() >= 1500 && count < Item.MAX_COUNT) {
			...
			while (Game.PLAYER.getCoins() >= 26 && count < Item.MAX_COUNT) {
			...
			while (Game.PLAYER.getCoins() >= 15 && count < Item.MAX_COUNT) {
