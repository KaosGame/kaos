package com.github.kaosgame.kaos.main;
...
import com.github.kaosgame.kaos.collision.objects.Bank1CollidableObjest;
import com.github.kaosgame.kaos.collision.objects.ChestTransparentObject;
import com.github.kaosgame.kaos.collision.objects.CollidableObject;
import com.github.kaosgame.kaos.collision.objects.CollidableWallObject;
import com.github.kaosgame.kaos.collision.objects.LastMapCollidableObject;
import com.github.kaosgame.kaos.collision.objects.LavaTransparentCollisionObject;
import com.github.kaosgame.kaos.collision.objects.NextRandomMapCollisionObject;
import com.github.kaosgame.kaos.collision.objects.Pot7Or2CollidableObject;
import com.github.kaosgame.kaos.collision.objects.StartMonsterLeathFightCollidableObject;
import com.github.kaosgame.kaos.collision.objects.TextSignObject;
...
import com.github.kaosgame.kaos.display.HUD;
import com.github.kaosgame.kaos.display.components.GamePanel;
import com.github.kaosgame.kaos.entities.AxolotlEntity;
import com.github.kaosgame.kaos.entities.BombEntity;
import com.github.kaosgame.kaos.entities.IsawawabubEntity;
import com.github.kaosgame.kaos.entities.ItemEntity;
import com.github.kaosgame.kaos.entities.bad.zombie.WarZombie;
...
import com.github.kaosgame.kaos.entities.cats.Kittnasours;
...
import com.github.kaosgame.kaos.entities.vilagers.VillagerEntity;
import com.github.kaosgame.kaos.entities.vilagers.VillagerTrades;
import com.github.kaosgame.kaos.exceptions.image.restoring.NotEnoughInformationToRestoreImageException;
import com.github.kaosgame.kaos.gui.base.GUI;
import com.github.kaosgame.kaos.logging.LogType;
import com.github.kaosgame.kaos.logging.Logger;
import com.github.kaosgame.kaos.maps.DimensionHandler;
import com.github.kaosgame.kaos.maps.DimensionID;
import com.github.kaosgame.kaos.maps.Map;
import com.github.kaosgame.kaos.maps.MapHandler;
import com.github.kaosgame.kaos.random.RandomGen;
import com.github.kaosgame.kaos.saving.GameVersion;
import com.github.kaosgame.kaos.saving.SaveableObject;
import com.github.kaosgame.kaos.saving.SavingGame;
import com.github.kaosgame.kaos.sound.Sound;
import com.github.kaosgame.kaos.sound.Sounds;
import com.github.kaosgame.kaos.textures.BufferedImageLoader;
import com.github.kaosgame.kaos.textures.TextraAlice;
...
public class Game {
	...
	public static final GameVersion VERSION = new GameVersion("Pre-0.0.2.0.0");
	...
	public static void fixImagesForCurrentMap(Map map) throws NotEnoughInformationToRestoreImageException {
		...
		Iterator<com.github.kaosgame.kaos.maps.Dimension> dimsListIt = Game.DIMENSION_HANDLER.getDimensionHashMap().values().iterator();
		
		while (dimsListIt.hasNext()) {
			
			com.github.kaosgame.kaos.maps.Dimension dim = dimsListIt.next();
